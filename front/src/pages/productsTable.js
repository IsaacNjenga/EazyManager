...
/*
  ...
  const columns = [
    ...
    { name: "Colour", selector: (row) => row.colour },
    { name: "Code", selector: (row) => row.code },
    { name: "Prod No.", selector: (row) => row.number },
    { name: "Quantity", selector: (row) => row.quantity },
    { name: "Batch No.", selector: (row) => row.bnumber },
    { name: "AMT", selector: (row) => row.amount },
    { name: "Location", selector: (row) => row.location },
    {
      name: "Total Quantity",
      selector: (row) => codeTotals[row.code],
    },
        ...
        <>
          <div className="buttons-container">
            <button
              ...
              onClick={() => productHistory(row._id)}
            >
              <i className="material-icons">visibility</i>
            </button>
            <button className="updatebtn" title="Update this record">
              <Link
            ...
            <button
              ...
              onClick={() => click(row._id)}
            >
              <i className="material-icons">delete</i>
            </button>
            {!userWantsToDelete && selectedProductNumber === row._id && (
              <div
                style={{
                  textAlign: "center",
                  alignItems: "center",
